 ...
 * -------------------------------------------------------------------
 * File: rt_sys_AUAV_V3_TestSensors_76.h
 *
...
#ifndef RTW_HEADER_rt_sys_AUAV_V3_TestSensors_76_h_
#define RTW_HEADER_rt_sys_AUAV_V3_TestSensors_76_h_
#include <math.h>
...
extern void AUAV_V3_Tes_AxisRotDefault(const real32_T rtu_In1[7], real32_T
  *rty_1, real32_T *rty_2, real32_T *rty_3);

#endif                                 /* RTW_HEADER_rt_sys_AUAV_V3_TestSensors_76_h_ */
