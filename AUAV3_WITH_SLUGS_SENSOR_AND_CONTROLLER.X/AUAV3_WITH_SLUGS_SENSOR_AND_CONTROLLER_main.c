...
{
  {
    ...
    static int_T taskCounter[13] = { 0, 0, 0, 0, 0, 0, 18, 16, 14, 12, 0, 0, 0 };
    ...
    taskCounter[12]++;
    if (taskCounter[12] == 100) {
      taskCounter[12]= 0;
    }

    /* Step the model for base rate */
    /* Start profiling task 0 */
    AUAV3_WITH_SLUGS_SENSOR_AND_CONTROLLER_step(0);
    ...
    if (event.Flags1) {
      ...
      do {
        ...
        event.Flags1 = 0U;
        AUAV3_WITH_SLUGS_SENSOR_AND_CONTROLLER_step(1);
    ...
    if (event.Flags2) {
      ...
      do {
        ...
        event.Flags2 = 0U;
        AUAV3_WITH_SLUGS_SENSOR_AND_CONTROLLER_step(2);
    ...
    if (event.Flags3) {
      ...
      do {
        ...
        event.Flags3 = 0U;
        AUAV3_WITH_SLUGS_SENSOR_AND_CONTROLLER_step(3);
    ...
    if (event.Flags4) {
      ...
      do {
        ...
        event.Flags4 = 0U;
        AUAV3_WITH_SLUGS_SENSOR_AND_CONTROLLER_step(4);
    ...
    if (event.Flags5) {
      ...
      do {
        ...
        event.Flags5 = 0U;
        AUAV3_WITH_SLUGS_SENSOR_AND_CONTROLLER_step(5);
    ...
    if (event.Flags6) {
      ...
      do {
        ...
        event.Flags6 = 0U;
        AUAV3_WITH_SLUGS_SENSOR_AND_CONTROLLER_step(6);
    ...
    if (event.Flags7) {
      ...
      do {
        ...
        event.Flags7 = 0U;
        AUAV3_WITH_SLUGS_SENSOR_AND_CONTROLLER_step(7);
    ...
    if (event.Flags8) {
      ...
      do {
        ...
        event.Flags8 = 0U;
        AUAV3_WITH_SLUGS_SENSOR_AND_CONTROLLER_step(8);
    ...
    if (event.Flags9) {
      ...
      do {
        ...
        event.Flags9 = 0U;
        AUAV3_WITH_SLUGS_SENSOR_AND_CONTROLLER_step(9);
    ...
    if (event.Flags10) {
      ...
      do {
        ...
        event.Flags10 = 0U;
        AUAV3_WITH_SLUGS_SENSOR_AND_CONTROLLER_step(10);
    ...
    if (event.Flags11) {
      ...
      do {
        ...
        event.Flags11 = 0U;
        AUAV3_WITH_SLUGS_SENSOR_AND_CONTROLLER_step(11);
    ...
    if (event.Flags12) {
      ...
      do {
        ...
        event.Flags12 = 0U;
        AUAV3_WITH_SLUGS_SENSOR_AND_CONTROLLER_step(12);
