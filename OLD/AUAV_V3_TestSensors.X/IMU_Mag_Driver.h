...
#define RTW_HEADER_IMU_Mag_Driver_h_
...
extern void AUAV__IMU_Mag_Driver_Start(void);
extern void AUAV_V3_Tes_IMU_Mag_Driver(void);

#endif                                 /* RTW_HEADER_IMU_Mag_Driver_h_ */
