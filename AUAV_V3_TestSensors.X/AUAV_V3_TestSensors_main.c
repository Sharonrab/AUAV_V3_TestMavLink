...
volatile uint_T MCHP_MCULoadResult[1] __attribute__ ((near)) ;
volatile uint_T MCHP_MCULoadPreviousTimerValue[1] __attribute__ ((near)) ;
volatile uint_T mcuFlagRecursion __attribute__ ((near)) = 0;
