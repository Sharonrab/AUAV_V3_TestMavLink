 ...
 * -------------------------------------------------------------------
 * File: rt_sys_AUAV_V3_TestSensors_75.h
 *
...
#ifndef RTW_HEADER_rt_sys_AUAV_V3_TestSensors_75_h_
#define RTW_HEADER_rt_sys_AUAV_V3_TestSensors_75_h_
#include <math.h>
...
extern void AUAV_V3_Test_AxisRotZeroR3(const real32_T rtu_In1[7], real32_T
  *rty_1, real32_T *rty_2, real32_T *rty_3);

#endif                                 /* RTW_HEADER_rt_sys_AUAV_V3_TestSensors_75_h_ */
