...
int main(int ac, char* av[])
{
	...
	try {
		...
		desc.add_options()
			...
			("port", po::value<string>(&opt_port)->default_value("COM5"), "serial port to use")
			("baud_rate", po::value<int>(&opt_baud_rate)->default_value(38400), "set the serial port baud rate")
