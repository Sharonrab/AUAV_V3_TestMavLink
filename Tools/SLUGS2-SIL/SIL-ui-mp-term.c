...
void sil_ui_update(void)
{
	...
	} else if (hasShownInitStates == 1 /*&& dcm_flags._.dead_reckon_enable == 1*/) { //sr
		...
		case 0:
		{
			switch (c) {
				...
				case '1': // switch mode to manual
					udb_pwIn[MODE_SWITCH_INPUT_CHANNEL] = 1000;// MODE_SWITCH_THRESHOLD_LOW + 1;
					break;
