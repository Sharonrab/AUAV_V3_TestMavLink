...
#ifndef RTW_HEADER_SLUGS2_private_h_
#define RTW_HEADER_SLUGS2_private_h_
#include "rtwtypes.h"
...
extern void SLUGS2_negprotect_l(real32_T rtu_val, rtB_negprotect_SLUGS2_p_T
  *localB);
extern void S_EmbeddedMATLABFunction_b(const real32_T rtu_x[3],
  rtB_EmbeddedMATLABFunction_b_T *localB);
extern void SLUGS2_ZerooutZ1(const real32_T rtu_Pin[3], rtB_ZerooutZ1_SLUGS2_T
  *localB);
extern void S_EmbeddedMATLABFunction_k(const real32_T rtu_x[3], const real32_T
  rtu_y[3], rtB_EmbeddedMATLABFunction_i_T *localB);
extern void SLUGS2_SelectNTerms(const real32_T rtu_T[3],
  rtB_SelectNTerms_SLUGS2_T *localB);
extern void SLUGS2_negprotect3(real32_T rtu_val, rtB_negprotect3_SLUGS2_T
  *localB);
...
#endif                                 /* RTW_HEADER_SLUGS2_private_h_ */
