...
void Position_and_Attitude_Filt(void)
{
  ...
  if (SLUGS2_B.ChecksifFixTypeis3updateSenso_p > 0) {
    ...
    for (colIdx = 0; colIdx < 3; colIdx++) {
      ...
      SLUGS2_B.In1[colIdx] += SLUGS2_ConstP.pooled65[colIdx] * tmp_0[0];
      SLUGS2_B.In1[colIdx] += SLUGS2_ConstP.pooled65[colIdx + 3] * tmp_0[1];
      SLUGS2_B.In1[colIdx] += SLUGS2_ConstP.pooled65[colIdx + 6] * tmp_0[2];
    }
