...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
 const mxArray * prhs[] )
{
  extern unsigned int sf_HILModel_process_check_sum_call( int nlhs, mxArray *
   plhs[], int nrhs, const mxArray * prhs[] );

  if(sf_HILModel_process_check_sum_call(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
unsigned int sf_process_autoinheritence_call( int nlhs, mxArray * plhs[], int
 nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_HILModel_autoinheritance_info( int nlhs, mxArray *
   plhs[], int nrhs, const mxArray * prhs[] );
  if(sf_HILModel_autoinheritance_info(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray
 * plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_HILModel_get_eml_resolved_functions_info( int nlhs,
   mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if(sf_HILModel_get_eml_resolved_functions_info(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
...
extern unsigned int sf_HILModel_method_dispatcher(SimStruct *S, unsigned int
...
{
  if(!strcmp(machineName,"HILModel")) {
    return(sf_HILModel_method_dispatcher(simstructPtr,chartFileNumber,method,data));
  }
  return 0;
}
extern void HILModel_terminator(void);
...
extern void HILModel_initializer(void);
extern void HILModel_register_exported_symbols(SimStruct* S);
extern void HILModel_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  HILModel_register_exported_symbols(S);
}
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if(sfMachineGlobalInitializerCallable) {
    ...
    if(!simModeIsRTWGen) {
      HILModel_debug_initialize();
    }
    HILModel_initializer();
  }
  return;
}
